...
const communities = [
  {
    ...
    description:
      "As the world's premier society, HTS provides a central hub for professionals in industry, government, and academia to collaborate and access resources.",
    points: [
  ...
  },
  {
    ...
    description:
      'A global network organization of over 80 "hands-on" heat treatment experts, including engineers, metallurgists, and consultants, who collaborate to support the industry in areas like problem-solving, equipment selection, and process optimization.',
    points: [],
  ...
  },
  {
    ...
    description:
      'IHEA offers online educational resources, training courses, webinars, and publications for the industrial process heating industry.',
    points: [],
  ...
  },
  {
    ...
    description:
      'A German-based working group for heat treatment and materials technology, featuring a strong network of company and individual members.',
    points: [],
  ...
  },
  {
    title: 'IFHTSE',
    description:
      'The International Federation for Heat Treatment and Surface Engineering is a global body comprising heat treatment and surface engineering associations worldwide.',
    points: [
  ...
  },
  {
    ...
    description:
      'A research center at Worcester Polytechnic Institute (WPI) where industry members and researchers collaborate on pre-competitive research to advance the heat treating industry.',
    points: [
  ...
  },
  {
    ...
    description:
      "As the world's largest trade association for the commercial heat treating industry, MTI offers advocacy, education, and networking opportunities.",
    points: [
  ...
  },
  {
    ...
    description:
      "Sweden's state-owned research institute, RISE works in collaboration with universities, industry, and the public sector to drive sustainable growth by strengthening competitiveness and renewal.",
    points: [],
  ...
  },
  {
    title: 'Swerim',
    description:
      'A leading Swedish research institute specializing in metals research, covering everything from process and product development to material properties. They work closely with industry to apply cutting-edge research.',
    points: [],
  ...
  },
  {
    ...
    description:
      'NADCA provides resources, education, and support for the die casting industry, which often involves heat treatment of dies and components.',
    points: [],
...
const onlineForums = [
  {
    ...
    description:
      'A large professional group for networking and discussing industry news, jobs, and technical questions.',
  ...
  },
  {
    ...
    description:
      'An active community for students and professionals to ask questions, share images of microstructures, and discuss materials science topics.',
...
export default function CommunityPage() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="flex items-center gap-3 text-3xl font-bold tracking-tight font-headline">
          <Users className="h-8 w-8 text-primary" />
          Community Network
        </h2>
        <p className="mt-2 max-w-2xl text-muted-foreground text-justify">
          The primary heat treatment community is the ASM Heat Treating Society
          (HTS), the world's largest professional network in the field. These
          communities are valuable for staying current, solving problems, and
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription className="text-justify">
            Connect with peers and experts in more informal settings to ask
            ...
            >
              <div className="flex-grow">
                <h3 className="font-semibold flex items-center gap-2 mb-2">
                  <forum.icon className="h-5 w-5 text-primary" />
                  {forum.name}
                </h3>
