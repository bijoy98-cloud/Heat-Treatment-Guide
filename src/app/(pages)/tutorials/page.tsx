...
import { Video, ExternalLink, GraduationCap } from 'lucide-react';
...
const videoCategories = [
  {
    ...
    videos: [
      ...
      {
        title:
          'Understanding Heat Treatment: Processes, Applications, and Benefits...',
        description:
          'Basic concepts and importance of heat treatment in metallurgy',
        channel: 'Heat Treatment of Steel - Bijoy Saha',
      ...
      },
      {
        ...
        description:
          'An overview of various techniques to achieve optimal results.',
        channel: 'Heat Treatment of Steel - Bijoy Saha',
      ...
      },
      {
        ...
        description:
          'A rundown of 10 essential tips for mastering the heat treatment of steel.',
        channel: 'Heat Treatment of Steel - Bijoy Saha',
      ...
      },
      {
        ...
        description:
          "An in-depth guide covering the fundamental concepts of metallurgy for beginners.",
        channel: 'Heat Treatment of Steel - Bijoy Saha',
  ...
  },
  {
    ...
    videos: [
      ...
      {
        title:
          '5 key points explaining why heat treatment tempering is so important!',
    ...
    videos: [
      {
        ...
        description:
          "Learn the key differences between adding and removing carbon from a steel's surface.",
        channel: 'Heat Treatment of Steel - Bijoy Saha',
      ...
      {
        title:
          'Introduction to Plasma Nitriding: A Modern Surface Treatment for Metals',
    ...
    videos: [
      {
        ...
        description:
          'Comparing forging and heat treatment for ultimate strength.',
        channel: 'Heat Treatment of Steel - Bijoy Saha',
      ...
      {
        title:
          'Introduction to Powder Metallurgy: Process, Applications, and Benefits.',
      ...
      {
        title:
          'Laser Welding Explained: Technology, Process, and Applications..',
        description:
          'An explanation of laser welding technology, its process, and various applications.',
        channel: 'Heat Treatment of Steel - Bijoy Saha',
      ...
      {
        title:
          'Heat Treatment Tips & Tricks: Expert Techniques for Superior Results.',
        description:
          'Expert techniques for achieving superior results in heat treatment.',
        channel: 'Heat Treatment of Steel - Bijoy Saha',
...
export default function TutorialsPage() {
  return (
    <div className="space-y-8">
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2 flex items-center gap-3 font-headline">
      ...
      <Card className="mb-8 bg-primary text-primary-foreground">
        <CardHeader>
          ...
          <CardDescription className="text-primary-foreground/90 text-justify">
            By Bijoy Saha - Professional video series covering all aspects of
            heat treatment
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div key={category.category}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {category.videos.map((video, index) => {
                const image = video.imageId
                  ? PlaceHolderImages.find((img) => img.id === video.imageId)
                  : undefined;
                return (
                  <Card
                    key={index}
